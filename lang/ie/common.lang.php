...
return array(
    ...
    'Use news story title' => 'Usar li titul del information',

    #: classes/model/post.model.php:15
    'Use news story summary' => 'Usar li summarium del information',

    #: config/controller/admin/appdesk.config.php:15
    #: config/controller/admin/appdesk.config.php:21
    'news stories' => 'informations',
    ...
    'Add a news story' => 'addir un information',

    #. Crud
    #: config/common/post.config.php:19
    'Good! A new story added to your collection.' => 'Bon ! Information addit.',

    #: config/common/post.config.php:20
    'The news story has been deleted.' => 'Li information ha esset deletet.',

    #. General errors
    #: config/common/post.config.php:23
    'This news story doesn’t exist any more. It has been deleted.' => 'Ti information ne existe plu. It ha esset deletet.',

    #: config/common/post.config.php:24
    'We cannot find this news story.' => 'Noi ne posse trovar ti information.',
