...
return array(
    ...
    'Use news story title' => 'Использовать заголовок новости',

    #: classes/model/post.model.php:15
    'Use news story summary' => 'Использовать краткое изложение новости',
    ...
    'Add a news story' => 'Добавить новость',

    #. Crud
    #: config/common/post.config.php:19
    'Good! A new story added to your collection.' => 'Отлично! Новость добавлена к вашей коллекции.',

    #: config/common/post.config.php:20
    'The news story has been deleted.' => 'Новость была удалена.',

    #. General errors
    #: config/common/post.config.php:23
    'This news story doesn’t exist any more. It has been deleted.' => 'Эта новость больше не существует. Она была удалена.',

    #: config/common/post.config.php:24
    'We cannot find this news story.' => 'Эта новость не обнаружена.',
